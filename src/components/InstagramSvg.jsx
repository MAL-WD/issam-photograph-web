const InstagramSvg = () => {
    const handleButtonClick = () => {
        window.location.href = 'https://www.instagram.com/issam_photographe_00?igsh=cHcwempneWk2bGV5';
      };
    return ( 
        <button onClick={handleButtonClick} className="p-2 hover:bg-main duration-300 cursor-pointer bg-light-main rounded-full" >
